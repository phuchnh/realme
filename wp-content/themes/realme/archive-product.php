            ...
            <div class="product-slide__wrap">
				<?php while ( $query->have_posts() ): $query->the_post() ?>
                  <div class="product-slide__item">
                    <!-- help class (!== homepage): top-product-slide__item--text-r, product-slide__item--text-r -->
                    <div class="container product-slide__item--text-r">
						<?php echo tr_posts_field( ':img:full:product_image' );; ?>

                      <!-- helper class (=== homepage): slide-text-align--l, slide-text-align--r, slide-text-align--c -->
                      <!-- helper class: text-white, text-black -->
