    ...
    <div class="top-slider__wrap">
		<?php while ( $query->have_posts() ): $query->the_post() ?>
          ...
          <div class="top-slider__item top-slider__item--text-bot bg-sp-black"
               style="background-image: url('<?php echo wp_get_attachment_image_url( tr_posts_field( 'banner_background' ), 'Full size' ); ?>')">
            <img src="<?php echo THEME_URI; ?>/assets/img/top-slider-03-sp.png" alt=""/>
            <div class="top-slider__item__desc">
              <!-- o day phai up 2 tam hinh co text, 1 o ban pc, 1 o ban sp -->
              <img src="<?php echo wp_get_attachment_image_url( tr_posts_field( 'desktop_banner.image' ), 'Full size' ); ?>"
                   class="hidden-sp" alt="realme"/>
              <img src="<?php echo wp_get_attachment_image_url( tr_posts_field( 'mobile_banner.image' ), 'Full size' ); ?>"
