! function (e) {
    ...
    (0, s.default)(function () {
        ...
        var P = window.location.hostname.indexOf("myoas.net") > 0 ? "https://account.myoas.net/" : "https://id.realme.com/",
            ...
            H = P + "?callback=" + encodeURIComponent(M) + "®ion=IN&language=en-IN",
            _ = P + "logout.html?callback=" + encodeURIComponent(M) + "®ion=IN&language=en-IN",
            R = P + "profile.html?callback=" + encodeURIComponent(M) + "®ion=IN&language=en-IN",
            ...
            W = F + "in/user/orders",
            B = F + "in/user/r-pass",
            U = P + "?callback=" + encodeURIComponent(W) + "®ion=IN&language=en-IN",
            $ = B + "?callback=" + encodeURIComponent(B) + "®ion=IN&language=en-IN",
            z = F + "in/user/addresses",
            X = P + "?callback=" + encodeURIComponent(z) + "®ion=IN&language=en-IN",
    ...
    function s(e) {
        var t = m(),
            ...
            s = o + "?callback=" + encodeURIComponent(a) + "®ion=IN&language=en-IN";
        i({
            type: "post",
            url: r + "login"
        }).then(function (t) {
