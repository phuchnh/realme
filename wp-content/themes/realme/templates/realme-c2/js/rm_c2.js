! function(e) {
  ...
  (0, a.default)(function() {
    var e = (0, a.default)(window).height(),
      t = (0, a.default)(window).width(),
      n = function() {
      ...
      i = new o.default("#secSpecsSwiper", {
        speed: 300,
        simulateTouch: !0,
        effect: "fade",
        fadeEffect: {
        ...
        on: {
          slideChange: function() {
            t < 769 && ((0, a.default)(".sec-spec-color-select").removeClass("sec-spec-color-select"), (0, a.default)(".sec-specs-color-select").eq(this.activeIndex).find("a").addClass("sec-spec-color-select"))
          }
        }
      });
    (0, a.default)(".sec-specs-color-select a").click(function() {
      var e = (0, a.default)(this),
        t = e.data("index");
      return i.slideTo(t), (0, a.default)(".sec-spec-color-select").removeClass("sec-spec-color-select"), e.addClass("sec-spec-color-select"), !1
    });
    var r = (new o.default(".specimenSwiper", {
        speed: 800,
        allowTouchMove: !0,
        preloadImages: !1,
        grabCursor: !0,
        ...
        a.default.each((0, a.default)("span.pic-lazyload"), function(t, n) {
          var i = (0, a.default)(n)[0].getBoundingClientRect().top;
          i < 1.3 * e && i > 1.3 * -e && (0, a.default)(n).replaceWith('<picture class="pic-lazyloaded">' + (0, a.default)(n).html() + "</picture>")
        }), a.default.each((0, a.default)(".sec-module").not(".bg-module-lazyload"), function(t, n) {
          var i = (0, a.default)(n)[0].getBoundingClientRect().top;
          i < 1.5 * e && i > 1.5 * -e && (0, a.default)(n).addClass("bg-module-lazyload")
        }), (0, d.default)()
      }),
      s = function() {
        a.default.each((0, a.default)(".sec").not(".sec-visible"), function(t, n) {
          var i = (0, a.default)(n).data("ratio") ? (0, a.default)(n).data("ratio") : .45,
            r = (0, a.default)(n).data("ratio") ? (0, a.default)(n).data("ratio") : 1,
            s = (0, a.default)(n)[0].getBoundingClientRect().top,
            o = n.className.split(" ");
          s < e * i && s > -e * i && (0, a.default)(n).addClass("sec-visible"), s < e * r && s > -e * r && o.length <= 3 && (0, a.default)(n).addClass(o[1] + "-active")
        }), a.default.each((0, a.default)(".sec-colorOS").not(".sec-replay-video"), function(t, n) {
          var i = (0, a.default)(n).data("ratio") ? (0, a.default)(n).data("ratio") : .5,
            r = (0, a.default)(n)[0].getBoundingClientRect().top;
          if (r < e * i && r > -e * i) {
            ! function() {
              var e = (0, a.default)(window).width(),
                t = (0, a.default)("#replay_two_video").data("video"),
                n = (0, a.default)("#replay_one_video").data("video");
              e <= 768 ? ((0, a.default)("#sec-colorOS-pic-shell").css("display", "none"), (0, a.default)(".sec-colorOS-pic-m").click(function() {
                (0, a.default)(".video-content").css("width", "40vh")
              }), (0, a.default)(".video-dialog-close").click(function() {
                (0, a.default)(".video-content").css("width", "90%")
              })) : ((0, a.default)("#sec-colorOS-pic-shell").css("display", "block"), (0, a.default)(".sec-replay-gesture").find("video").length <= 0 && ((0, a.default)(".sec-replay-gesture").children().remove(), (0, a.default)(".sec-replay-gesture").append('<video src="' + t + '" autoplay="true" loop="loop" muted="muted" id="video-two-itself"></video>')), (0, a.default)(".sec-replay-drawer").find("video").length <= 0 && ((0, a.default)(".sec-replay-drawer").children().remove(), (0, a.default)(".sec-replay-drawer").append('<video src="' + n + '" autoplay="true" loop="loop" muted="muted" id="video-one-itself"></video>')))
            }()
          }
        })
      };
    (0, a.default)(window).resize(function() {
      n(), s(), r()
  ...
  ! function(t, n) {
    ...
    function p(e) {
      var t = {};
      return Se.each(e.match(Oe) || [], function(e, n) {
        t[n] = !0
      }), t
    }
    ...
    function y(e) {
      return e.replace(Be, "ms-").replace(Re, g)
    }
    ...
    function H(e, t, n, i) {
      ...
      if (v || p > 1 && "string" == typeof h && !we.checkClone && ut.test(h)) return e.each(function(r) {
        var a = e.eq(r);
        v && (t[0] = h.call(this, r, a.html())), H(a, t, n, i)
      });
    ...
    var Me = function(e) {
      function t(e, t, n, i) {
        ...
        if (!i && ((t ? t.ownerDocument || t : q) !== D && L(t), t = t || D, $)) {
          if (11 !== h && (l = ve.exec(e)))
            if (r = l[1]) {
              if (9 === h) {
            ...
            if (1 !== h) f = t, p = e;
              ...
              for ((o = t.getAttribute("id")) ? o = o.replace(be, xe) : t.setAttribute("id", o = j), u = C(e), a = u.length; a--;) u[a] = "#" + o + " " + c(u[a]);
      ...
      function p(e, t, n) {
        ...
        return t.first ? function(t, n, r) {
          ...
          if (l) {
            ...
            for (; t = t[i];)
              if (1 === t.nodeType || s)
                if (c = t[j] || (t[j] = {}), u = c[t.uniqueID] || (c[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[i] || t;
                else {
                  if ((d = u[a]) && d[0] === B && d[1] === o) return p[2] = d[2];
      ...
      function g(e) {
        for (var t, n, i, r = e.length, a = w.relative[e[0].type], s = a || w.relative[" "], o = a ? 1 : 0, l = p(function(e) {
          ...
          if (n = w.relative[e[o].type]) u = [p(f(u), n)];
            ...
            if (n = w.filter[e[o].type].apply(null, e[o].matches), n[j]) {
        ...
        var r = n.length > 0,
          ...
          s = function(i, s, o, l, d) {
            var u, c, p, f = 0,
              ...
              T = b.length;
            for (d && (M = s === D || s || d); h !== T && null != (u = b[h]); h++) {
              if (a && u) {
                for (c = 0, s || u.ownerDocument === D || (L(u), o = !$); p = e[c++];)
                  if (p(u, s || D, o)) {
                    l.push(u);
                    break
                  } d && (B = x)
      ...
      var b, x, w, T, E, C, S, k, M, A, P, L, D, z, $, I, N, O, H, j = "sizzle" + 1 * new Date,
        q = e.document,
        B = 0,
        R = 0,
        F = n(),
      ...
      try {
        K.apply(Y = Q.call(q.childNodes), q.childNodes), Y[q.childNodes.length].nodeType
      } catch (e) {
        K = {
      ...
      x = t.support = {}, E = t.isXML = function(e) {
        ...
        return i !== D && 9 === i.nodeType && i.documentElement ? (D = i, z = D.documentElement, $ = !E(D), q !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), x.attributes = r(function(e) {
          return e.className = "i", !e.getAttribute("className")
        }), x.getElementsByTagName = r(function(e) {
          return e.appendChild(D.createComment("")), !e.getElementsByTagName("*").length
        }), x.getElementsByClassName = he.test(D.getElementsByClassName), x.getById = r(function(e) {
          return z.appendChild(e).id = j, !D.getElementsByName || !D.getElementsByName(j).length
        ...
        })), (x.matchesSelector = he.test(O = z.matches || z.webkitMatchesSelector || z.mozMatchesSelector || z.oMatchesSelector || z.msMatchesSelector)) && r(function(e) {
          x.disconnectedMatch = O.call(e, "*"), O.call(e, "[s!='']:x"), N.push("!=", ie)
        }), I = I.length && new RegExp(I.join("|")), N = N.length && new RegExp(N.join("|")), t = he.test(z.compareDocumentPosition), H = t || he.test(z.contains) ? function(e, t) {
          ...
          return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === q && H(q, e) ? -1 : t === D || t.ownerDocument === q && H(q, t) ? 1 : A ? J(A, e) - J(A, t) : 0 : 4 & n ? -1 : 1)
        } : function(e, t) {
          if (e === t) return P = !0, 0;
          var n, i = 0,
            r = e.parentNode,
            ...
            o = [e],
            l = [t];
          if (!r || !a) return e === D ? -1 : t === D ? 1 : r ? -1 : a ? 1 : A ? J(A, e) - J(A, t) : 0;
          if (r === a) return s(e, t);
          for (n = e; n = n.parentNode;) o.unshift(n);
          for (n = t; n = n.parentNode;) l.unshift(n);
          for (; o[i] === l[i];) i++;
          return i ? s(o[i], l[i]) : o[i] === q ? -1 : l[i] === q ? 1 : 0
        }, D) : D
      }, t.matches = function(e, n) {
        return t(e, null, null, n)
      }, t.matchesSelector = function(e, n) {
        if ((e.ownerDocument || e) !== D && L(e), n = n.replace(le, "='$1']"), x.matchesSelector && $ && !W[n + " "] && (!N || !N.test(n)) && (!I || !I.test(n))) try {
          var i = O.call(e, n);
        ...
        filter: {
            ...
            return 1 === i && 0 === r ? function(e) {
              ...
              if (m) {
                ...
                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                  for (p = m, c = p[j] || (p[j] = {}), u = c[p.uniqueID] || (c[p.uniqueID] = {}), d = u[e] || [], f = d[0] === B && d[1], b = f && d[2], p = f && m.childNodes[f]; p = ++f && p && p[v] || (b = f = 0) || h.pop();)
                    if (1 === p.nodeType && ++b && p === t) {
                      u[e] = [B, f, b];
                      break
                    }
                } else if (y && (p = t, c = p[j] || (p[j] = {}), u = c[p.uniqueID] || (c[p.uniqueID] = {}), d = u[e] || [], f = d[0] === B && d[1], b = f), !1 === b)
                  for (;
                    (p = ++f && p && p[v] || (b = f = 0) || h.pop()) && ((o ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++b || (y && (c = p[j] || (p[j] = {}), u = c[p.uniqueID] || (c[p.uniqueID] = {}), u[e] = [B, b]), p !== t)););
          ...
          PSEUDO: function(e, n) {
            ...
            return a[j] ? a(n) : a.length > 1 ? (r = [e, e, "", n], w.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
      ...
      return u.prototype = w.filters = w.pseudos, w.setFilters = new u, C = t.tokenize = function(e, n) {
        ...
        var n, i = [],
          ...
          a = W[e + " "];
        if (!a) {
          for (t || (t = C(e)), n = t.length; n--;) a = g(t[n]), a[j] ? i.push(a) : r.push(a);
      ...
      }, x.sortStable = j.split("").sort(X).join("") === j, x.detectDuplicates = !!P, L(), x.sortDetached = r(function(e) {
    ...
    (Se.fn.init = function(e, t, n) {
      ...
      if (n = n || ze, "string" == typeof e) {
        ...
        if (i[1]) {
          if (t = t instanceof Se ? t[0] : t, Se.merge(this, Se.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ue, !0)), De.test(i[1]) && Se.isPlainObject(t))
    ...
    Se.fn.extend({
      ...
      Se.fn[e] = function(n, i) {
        ...
        return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = Se.filter(i, r)), this.length > 1 && (Ne[e] || Se.uniqueSort(r), Ie.test(e) && r.reverse()), this.pushStack(r)
      }
    });
    var Oe = /[^\x20\t\r\n\f]+/g;
    ...
    Se.fn.ready = function(e) {
      ...
      readyWait: 1,
      ready: function(e) {
        (!0 === e ? --Se.readyWait : Se.isReady) || (Se.isReady = !0, !0 !== e && --Se.readyWait > 0 || je.resolveWith(ue, [Se]))
      }
    }), Se.ready.then = je.then, "complete" === ue.readyState || "loading" !== ue.readyState && !ue.documentElement.doScroll ? n.setTimeout(Se.ready) : (ue.addEventListener("DOMContentLoaded", m), n.addEventListener("load", m));
    ...
    b.uid = 1, b.prototype = {
      ...
      remove: function(e, t) {
        ...
        if (void 0 !== i) {
          if (void 0 !== t) {
            Array.isArray(t) ? t = t.map(y) : (t = y(t), t = t in i ? [t] : t.match(Oe) || []), n = t.length;
            for (; n--;) delete i[t[n]]
    ...
    Se.event = {
      ...
      add: function(e, t, n, i, r) {
        ...
        if (m)
          ...
          }), t = (t || "").match(Oe) || [""], d = t.length; d--;) o = ot.exec(t[d]) || [], f = v = o[1], h = (o[2] || "").split(".").sort(), f && (c = Se.event.special[f] || {}, f = (r ? c.delegateType : c.bindType) || f, c = Se.event.special[f] || {}, u = Se.extend({
            type: f,
            origType: v,
            data: i,
            handler: n,
    ...
    Se.extend({
      ...
      clone: function(e, t, n) {
        ...
        if (!(we.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || Se.isXMLDoc(e)))
          for (s = S(o), a = S(e), i = 0, r = a.length; i < r; i++) O(a[i], s[i]);
        if (t)
          if (n)
            for (a = a || S(e), s = s || S(o), i = 0, r = a.length; i < r; i++) N(a[i], s[i]);
          else N(e, o);
    ...
    Se.extend({
      ...
      css: function(e, t, n, i) {
        var r, a, s, o = y(t);
        return mt.test(t) || (t = F(o)), s = Se.cssHooks[t] || Se.cssHooks[o], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = q(e, t, i)), "normal" === r && t in yt && (r = yt[t]), "" === n || n ? (a = parseFloat(r), !0 === n || isFinite(a) ? a || 0 : r) : r
      }
    ...
    }), Se.cssHooks.marginLeft = B(we.reliableMarginLeft, function(e, t) {
      if (t) return (parseFloat(q(e, "marginLeft")) || e.getBoundingClientRect().left - Qe(e, {
        marginLeft: 0
      }, function() {
    ...
    Se.extend(Se.event, {
      trigger: function(e, t, i, r) {
        ...
        if (s = p = o = i = i || ue, 3 !== i.nodeType && 8 !== i.nodeType && !Lt.test(h + Se.event.triggered) && (h.indexOf(".") > -1 && (v = h.split("."), h = v.shift(), v.sort()), d = h.indexOf(":") < 0 && "on" + h, e = e[Se.expando] ? e : new Se.Event(h, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : Se.makeArray(t, [e]), c = Se.event.special[h] || {}, r || !c.trigger || !1 !== c.trigger.apply(i, t))) {
          ...
          return e.type = h, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), t) || !Fe(i) || d && Te(i[h]) && !Ee(i) && (o = i[d], o && (i[d] = null), Se.event.triggered = h, e.isPropagationStopped() && p.addEventListener(h, Dt), i[h](), e.isPropagationStopped() && p.removeEventListener(h, Dt), Se.event.triggered = void 0, o && (i[d] = o)), e.result
        }
      },
    ...
    Se.param = function(e, t) {
      ...
      serializeArray: function() {
        return this.map(function() {
          ...
          var e = this.type;
          return this.name && !Se(this).is(":disabled") && jt.test(this.nodeName) && !Ht.test(e) && (this.checked || !Ze.test(e))
        }).map(function(e, t) {
          var n = Se(this).val();
    ...
    Ut.href = zt.href, Se.extend({
      ...
      ajax: function(e, t) {
        ...
        if (g.promise(E), h.url = ((e || h.url || zt.href) + "").replace(Xt, zt.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Oe) || [""], null == h.crossDomain) {
        ...
        c = Se.event && h.global, c && 0 == Se.active++ && Se.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Wt.test(h.type), a = h.url.replace(Bt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(qt, "+")) : (f = h.url.slice(a.length), h.data && (h.processData || "string" == typeof h.data) && (a += (It.test(a) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (a = a.replace(Rt, "$1"), f = (It.test(a) ? "&" : "?") + "_=" + $t++ + f), h.url = a + f), h.ifModified && (Se.lastModified[a] && E.setRequestHeader("If-Modified-Since", Se.lastModified[a]), Se.etag[a] && E.setRequestHeader("If-None-Match", Se.etag[a])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && E.setRequestHeader("Content-Type", h.contentType), E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + _t + "; q=0.01" : "") : h.accepts["*"]);
    ...
    Se.ajaxSetup({
      ...
      var i, r, a;
      return t || (we.createHTMLDocument ? (t = ue.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = ue.location.href, t.head.appendChild(i)) : t = ue), r = De.exec(e), a = !n && [], r ? [t.createElement(r[1])] : (r = M([e], t, a), a && a.length && Se(a).remove(), Se.merge([], r.childNodes))
      ...
      Se.cssHooks[t] = B(we.pixelPosition, function(e, n) {
        if (n) return n = q(e, t), pt.test(n) ? Se(e).position()[t] + "px" : n
      })
    }), Se.each({
      Height: "height",
      Width: "width"
  ...
  ! function(t, n) {
    ...
    function S(e) {
      if (void 0 === e) return this;
      var t, n = this.length;
      return e > n - 1 ? new Ne([]) : e < 0 ? (t = n + e, new Ne(t < 0 ? [] : [this[t]])) : new Ne([this[e]])
    }
    ...
    function A(t) {
      return new Ne(this.length > 0 ? t ? this[0].nextElementSibling && e(this[0].nextElementSibling).is(t) ? [this[0].nextElementSibling] : [] : this[0].nextElementSibling ? [this[0].nextElementSibling] : [] : [])
    }
    ...
    function L(t) {
      if (this.length > 0) {
        var n = this[0];
        return new Ne(t ? n.previousElementSibling && e(n.previousElementSibling).is(t) ? [n.previousElementSibling] : [] : n.previousElementSibling ? [n.previousElementSibling] : [])
      }
      return new Ne([])
    }
    ...
    function q() {
      var e, t, n = this,
        i = n.$el;
      e = void 0 !== n.params.width ? n.params.width : i[0].clientWidth, t = void 0 !== n.params.height ? n.params.height : i[0].clientHeight, 0 === e && n.isHorizontal() || 0 === t && n.isVertical() || (e = e - parseInt(i.css("padding-left"), 10) - parseInt(i.css("padding-right"), 10), t = t - parseInt(i.css("padding-top"), 10) - parseInt(i.css("padding-bottom"), 10), He.extend(n, {
        width: e,
        height: t,
          ...
          if ("none" !== M.css("display")) {
            if ("auto" === t.slidesPerView) {
              ...
              if (z && (M[0].style.transform = "none"), $ && (M[0].style.webkitTransform = "none"), t.roundLengths) T = e.isHorizontal() ? M.outerWidth(!0) : M.outerHeight(!0);
                ...
                T = X && "border-box" === X ? B + G + W : B + R + F + G + W
              }
              z && (M[0].style.transform = z), $ && (M[0].style.webkitTransform = $), t.roundLengths && (T = Math.floor(T))
    ...
    function W(e) {
      ...
      var t = this,
        ...
        o = a,
        l = s;
      0 === i ? (r = 0, a = !0, s = !0) : (r = (e - t.minTranslate()) / i, a = r <= 0, s = r >= 1), He.extend(t, {
        progress: r,
        isBeginning: a,
        isEnd: s
    ...
    function U(e, t) {
      var n = this,
        ...
        o = 0,
        l = 0;
      n.isHorizontal() ? o = i ? -e : e : l = e, r.roundLengths && (o = Math.floor(o), l = Math.floor(l)), r.virtualTranslate || (je.transforms3d ? a.transform("translate3d(" + o + "px, " + l + "px, 0px)") : a.transform("translate(" + o + "px, " + l + "px)")), n.previousTranslate = n.translate, n.translate = n.isHorizontal() ? o : l;
    ...
    function oe() {
      ...
      if (i.loop) {
        ...
        t = parseInt(e(n.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? s < n.loopedSlides - a / 2 || s > n.slides.length - n.loopedSlides + a / 2 ? (n.loopFix(), s = r.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), He.nextTick(function() {
          n.slideTo(s)
        })) : n.slideTo(s) : s > n.slides.length - a ? (n.loopFix(), s = r.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), He.nextTick(function() {
          n.slideTo(s)
        })) : n.slideTo(s)
      } else n.slideTo(s)
    }
    ...
    function he(e) {
      ...
      n.loop && t.loopCreate(), n.observer && je.observer || t.update(), t.slideTo(a, 0, !1)
    }
    ...
    function ve(e, t) {
      ...
      r.loop && n.loopCreate(), r.observer && je.observer || n.update(), r.loop ? n.slideTo(l + n.loopedSlides, 0, !1) : n.slideTo(l, 0, !1)
    }
    ...
    function me(e) {
      ...
      n.loop && t.loopCreate(), n.observer && je.observer || t.update(), n.loop ? t.slideTo(o + t.loopedSlides, 0, !1) : t.slideTo(o, 0, !1)
    }
          ...
          if (!r.swipeHandler || e(s).closest(r.swipeHandler)[0]) {
            ...
            if (!d || !(o <= u || o >= Ie.screen.width - u)) {
              if (He.extend(i, {
                ...
                isScrolling: void 0,
                startMoving: void 0
              }), a.startX = o, a.startY = l, i.touchStartTime = He.now(), n.allowClick = !0, n.updateSize(), n.swipeDirection = void 0, r.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== s.type) {
                var c = !0;
    ...
    function be(t) {
      ...
      if (!i.isTouchEvent || "mousemove" !== o.type) {
        ...
        if (!n.allowTouchMove) return n.allowClick = !1, void(i.isTouched && (He.extend(a, {
          startX: l,
          startY: d,
          currentX: l,
          currentY: d
        }), i.touchStartTime = He.now()));
    ...
    function xe(e) {
      ...
      if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap", d), c < 300 && u - n.lastClickTime > 300 && (n.clickTimeout && clearTimeout(n.clickTimeout), n.clickTimeout = He.nextTick(function() {
        t && !t.destroyed && t.emit("click", d)
      }, 300)), c < 300 && u - n.lastClickTime < 300 && (n.clickTimeout && clearTimeout(n.clickTimeout), t.emit("doubleTap", d))), n.lastClickTime = He.now(), He.nextTick(function() {
        ...
        if (i.freeModeMomentum) {
          if (n.velocities.length > 1) {
            var f = n.velocities.pop(),
              ...
              m = f.time - h.time;
            t.velocity = v / m, t.velocity /= 2, Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (m > 150 || He.now() - f.time > 300) && (t.velocity = 0)
          } else t.velocity = 0;
    ...
    function Ee() {
      ...
      if (je.touch || !je.pointerEvents && !je.prefixedPointerEvents) {
        if (je.touch) {
          var o = !("touchstart" !== n.start || !je.passiveListener || !t.passiveListeners) && {
            passive: !0,
            capture: !1
          };
          a.addEventListener(n.start, e.onTouchStart, o), a.addEventListener(n.move, e.onTouchMove, je.passiveListener ? {
            passive: !1,
            capture: s
          } : s), a.addEventListener(n.end, e.onTouchEnd, o)
        }(t.simulateTouch && !_e.ios && !_e.android || t.simulateTouch && !je.touch && _e.ios) && (a.addEventListener("mousedown", e.onTouchStart, !1), $e.addEventListener("mousemove", e.onTouchMove, s), $e.addEventListener("mouseup", e.onTouchEnd, !1))
    ...
    function Ce() {
      ...
      if (je.touch || !je.pointerEvents && !je.prefixedPointerEvents) {
        if (je.touch) {
          var o = !("onTouchStart" !== n.start || !je.passiveListener || !t.passiveListeners) && {
            passive: !0,
            capture: !1
          };
        ...
        }(t.simulateTouch && !_e.ios && !_e.android || t.simulateTouch && !je.touch && _e.ios) && (a.removeEventListener("mousedown", e.onTouchStart, !1), $e.removeEventListener("mousemove", e.onTouchMove, s), $e.removeEventListener("mouseup", e.onTouchEnd, !1))
    ...
    function Se() {
      ...
      if (a && (!a || 0 !== Object.keys(a).length)) {
        ...
        if (s && e.currentBreakpoint !== s) {
          ...
          He.extend(e.params, l), He.extend(e, {
    ...
    function Me() {
      var e = this,
        ...
        r = e.$el,
        a = [];
      a.push(n.direction), n.freeMode && a.push("free-mode"), je.flexbox || a.push("no-flexbox"), n.autoHeight && a.push("autoheight"), i && a.push("rtl"), n.slidesPerColumn > 1 && a.push("multirow"), _e.android && a.push("android"), _e.ios && a.push("ios"), (Qe.isIE || Qe.isEdge) && (je.pointerEvents || je.prefixedPointerEvents) && a.push("wp8-" + n.direction), a.forEach(function(e) {
          ...
          for (var n = Object(e[0]), i = 1; i < e.length; i += 1) {
            ...
            if (void 0 !== r && null !== r)
              for (var a = Object.keys(Object(r)), s = 0, o = a.length; s < o; s += 1) {
                ...
                void 0 !== d && d.enumerable && (He.isObject(n[l]) && He.isObject(r[l]) ? He.extend(n[l], r[l]) : !He.isObject(n[l]) && He.isObject(r[l]) ? (n[l] = {}, He.extend(n[l], r[l])) : n[l] = r[l])
              }
          }
          return n
        }
    ...
    qe.prototype.on = function(e, t, n) {
      ...
      var r = e.name || Object.keys(i.prototype.modules).length + "_" + He.now();
    ...
    var Re = {
      ...
      rt = function(t) {
        function n() {
          for (var i, r = [], a = arguments.length; a--;) r[a] = arguments[a];
          var s, o;
          1 === r.length && r[0].constructor && r[0].constructor === Object ? o = r[0] : (i = r, s = i[0], o = i[1]), o || (o = {}), o = He.extend({}, o), s && !o.el && (o.el = s), t.call(this, o), Object.keys(nt).forEach(function(e) {
          ...
          var d = He.extend({}, tt);
          l.useModulesParams(d), l.params = He.extend({}, d, it, o), l.originalParams = He.extend({}, l.params), l.passedParams = He.extend({}, o), l.$ = e;
          var u = e(l.params.el);
          if (s = u[0]) {
            if (u.length > 1) {
              var c = [];
        ...
        return n.prototype.slidesPerViewDynamic = function() {
          ...
          return void 0 === n.params || n.destroyed ? null : (n.emit("beforeDestroy"), n.initialized = !1, n.detachEvents(), i.loop && n.loopDestroy(), t && (n.removeClasses(), r.removeAttr("style"), a.removeAttr("style"), s && s.length && s.removeClass([i.slideVisibleClass, i.slideActiveClass, i.slideNextClass, i.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index").removeAttr("data-swiper-column").removeAttr("data-swiper-row")), n.emit("destroy"), Object.keys(n.eventsListeners).forEach(function(e) {
            n.off(e)
          }), !1 !== e && (n.$el[0].swiper = null, n.$el.data("swiper", null), He.deleteProps(n)), n.destroyed = !0, null)
      ...
      vt = {
        ...
        event: function() {
          return Ie.navigator.userAgent.indexOf("firefox") > -1 ? "DOMMouseScroll" : ze() ? "wheel" : "mousewheel"
        }(),
        ...
        handle: function(e) {
          ...
          if (i.invert && (r = -r), n.params.freeMode) {
            ...
            var o = n.getTranslate() + r * i.sensitivity,
              l = n.isBeginning,
              d = n.isEnd;
            if (o >= n.minTranslate() && (o = n.minTranslate()), o <= n.maxTranslate() && (o = n.maxTranslate()), n.setTransition(0), n.setTranslate(o), n.updateProgress(), n.updateActiveIndex(), n.updateSlidesClasses(), (!l && n.isBeginning || !d && n.isEnd) && n.updateSlidesClasses(), n.params.freeModeSticky && (clearTimeout(n.mousewheel.timeout), n.mousewheel.timeout = He.nextTick(function() {
              n.slideToClosest()
            ...
            if (He.now() - n.mousewheel.lastScrollTime > 60)
              if (r < 0)
      ...
      wt = {
        ...
        updateSize: function() {
          ...
          if (e.params.scrollbar.el && e.scrollbar.el) {
            ...
            var r, a = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
              ...
              o = s * (a / e.size);
            r = "auto" === e.params.scrollbar.dragSize ? a * s : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? n[0].style.width = r + "px" : n[0].style.height = r + "px", i[0].style.display = s >= 1 ? "none" : "", e.params.scrollbarHide && (i[0].style.opacity = 0), He.extend(t, {
              trackSize: a,
              divider: s,
              moveDivider: o,
              dragSize: r
        ...
        enableDraggable: function() {
          ...
          if (e.params.scrollbar.el) {
            var t = e.scrollbar,
              ...
              a = t.$el,
              s = a[0],
              o = !(!je.passiveListener || !r.passiveListeners) && {
                passive: !1,
                capture: !1
              },
              l = !(!je.passiveListener || !r.passiveListeners) && {
                passive: !0,
                capture: !1
              };
            je.touch ? (s.addEventListener(n.start, e.scrollbar.onDragStart, o), s.addEventListener(n.move, e.scrollbar.onDragMove, o), s.addEventListener(n.end, e.scrollbar.onDragEnd, l)) : (s.addEventListener(i.start, e.scrollbar.onDragStart, o), $e.addEventListener(i.move, e.scrollbar.onDragMove, o), $e.addEventListener(i.end, e.scrollbar.onDragEnd, l))
          }
        },
        disableDraggable: function() {
          ...
          if (e.params.scrollbar.el) {
            ...
            je.touch ? (s.removeEventListener(n.start, e.scrollbar.onDragStart, o), s.removeEventListener(n.move, e.scrollbar.onDragMove, o), s.removeEventListener(n.end, e.scrollbar.onDragEnd, l)) : (s.removeEventListener(i.start, e.scrollbar.onDragStart, o), $e.removeEventListener(i.move, e.scrollbar.onDragMove, o), $e.removeEventListener(i.end, e.scrollbar.onDragEnd, l))
          }
        },
        init: function() {
          var t = this;
          if (t.params.scrollbar.el) {
            ...
            0 === s.length && (s = e('<div class="' + t.params.scrollbar.dragClass + '"></div>'), a.append(s)), He.extend(n, {
              $el: a,
              el: a[0],
              $dragEl: s,
              dragEl: s[0]
      ...
      St = {
        ...
        onGestureStart: function(t) {
          var n = this,
            ...
            r = n.zoom,
            a = r.gesture;
          if (r.fakeGestureTouched = !1, r.fakeGestureMoved = !1, !je.gestures) {
      ...
      Pt = {
        ...
        setTransition: function(e, t) {
          function n(t) {
            t.setTransition(e, r), 0 !== e && (t.transitionStart(), t.params.autoHeight && He.nextTick(function() {
              t.updateAutoHeight()
      ...
      Ht = {
        run: function() {
          ...
          t.attr("data-swiper-autoplay") && (n = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), e.autoplay.timeout = He.nextTick(function() {
      ...
      Rt = {
        setTranslate: function() {
          ...
          if (r.css({
            ...
            } var D = Qe.isSafari || Qe.isUiWebView ? -d / 2 : 0;
          r.transform("translate3d(0px,0," + D + "px) rotateX(" + (n.isHorizontal() ? 0 : f) + "deg) rotateY(" + (n.isHorizontal() ? -f : 0) + "deg)")
        },
        setTransition: function(e) {
          var t = this,
            n = t.$el;
      ...
      Yt = {
        init: function() {
          var e = this,
            ...
            n = t.thumbs,
            i = e.constructor;
          n.swiper instanceof i ? (e.thumbs.swiper = n.swiper, He.extend(e.thumbs.swiper.originalParams, {
            watchSlidesProgress: !0,
            slideToClickedSlide: !1
          }), He.extend(e.thumbs.swiper.params, {
            watchSlidesProgress: !0,
            slideToClickedSlide: !1
          })) : He.isObject(n.swiper) && (e.thumbs.swiper = new i(He.extend({}, n.swiper, {
      ...
      Ut = [at, st, ot, lt, ut, pt, ht, mt, yt, xt, Tt, Ct, kt, At, Lt, zt, It, Ot, jt, Bt, Ft, Wt, Vt, _t];
  ...
  ! function(e) {
    ...
    function(r, a, s) {
      ...
      function l() {
        H = !1, B = r.devicePixelRatio, j = {}, q = {}, x.DPR = B || 1, R.width = Math.max(r.innerWidth || 0, M.clientWidth), R.height = Math.max(r.innerHeight || 0, M.clientHeight), R.vw = R.width / 100, R.vh = R.height / 100, b = [R.height, R.width, B].join("-"), R.em = x.getEmValue(), R.rem = R.em
      }
      ...
      var g, y, b, x = {},
        ...
        D = /rident/.test(L) || /ecko/.test(L) && L.match(/rv\:(\d+)/) && RegExp.$1 > 35,
        z = "currentSrc",
        $ = /\s+\+?\d+(e\d+)?w/,
        I = /(\([^)]+\))?\s*(.+)/,
        N = r.picturefillCFG,
        ...
        J = function() {
          ...
          return function(t, i) {
            var r;
            if (!(t in j))
              if (j[t] = !1, i && (r = t.match(e))) j[t] = r[1] * R[r[2]];
              else try {
                j[t] = new Function("e", n(t))(R)
              } catch (e) {}
            return j[t]
          }
        }(),
      ...
      r.console && console.warn, z in E || (z = "src"), A["image/jpeg"] = !0, A["image/gif"] = !0, A["image/png"] = !0, A["image/svg+xml"] = a.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), x.ns = ("pf" + (new Date).getTime()).substr(0, 9), x.supSrcset = "srcset" in E, x.supSizes = "sizes" in E, x.supPicture = !!r.HTMLPictureElement, x.supSrcset && x.supPicture && !x.supSizes && function(e) {
      ...
      }() : w = !0, x.selShort = "picture>img,img[srcset]", x.sel = x.selShort, x.cfg = P, x.DPR = B || 1, x.u = R, x.types = A, x.setSize = T, x.makeUrl = Q(function(e) {
        ...
        if (!g && (e = a.body)) {
          var t = a.createElement("div"),
            n = M.style.cssText,
            i = e.style.cssText;
          t.style.cssText = "position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)", M.style.cssText = O, e.style.cssText = O, e.appendChild(t), g = t.offsetWidth, e.removeChild(t), g = parseFloat(g, 10), M.style.cssText = n, e.style.cssText = i
        }
        return g || 16
        ...
        if (e.length) {
          var n, i, r, a, s, o, l, u, f, h = t[x.ns],
            v = x.DPR;
          if (o = h.curSrc || t[z], l = h.curCan || p(t, o, e[0].set), l && l.set === e[0].set && ((f = D && !t.complete && l.res - .1 > v) || (l.cached = !0, l.res >= v && (s = l))), !s)
        ...
        var e, t = r.attachEvent ? /d$|^c/ : /d$|^c|^i/,
          ...
          s = M.clientHeight,
          o = function() {
            H = Math.max(r.innerWidth || 0, M.clientWidth) !== R.width || M.clientHeight !== s, s = M.clientHeight, H && x.fillImgs()
          };
